...
//		File deltaKBFile = new File ("input/jfreechart/0.9.10_0.9.11delta.rub");
	...
	public void filterFacts (PrintStream p, TreeSet<LSDFact> output, LSdiffFilter filter ) { 
		//MK 020611: HERE IS PLACE THAT I CAN TURN ON and OFF

		if (RestrictionOption.OPTION_ModifiedFactON) {
			// I can figure out the option of
			// "creating an additional modified predicates"
			assert (filter != null);
			...
			output.addAll(this.originalDeltaKB);
		}
	}
